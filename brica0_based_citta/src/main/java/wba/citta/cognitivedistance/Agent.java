...
public class Agent {
     ...
     */
    public List<Integer> getNextState(List<Integer> currentState, List<Integer> goalState) {
        /* 学習処理 */
        interfaceAgent.learn(currentState);

        /* 次の状態を取得 */
        List<Integer> nextState = interfaceAgent.exec(currentState,goalState);
    ...
    public void save(String fileName) throws IOException {
        logger.info("Saving learning data %s...", fileName);
        /* ストリームの作成 */
...
//    }
     ...
     */
    public Map<Integer, List<Integer>> getStateTable() {
