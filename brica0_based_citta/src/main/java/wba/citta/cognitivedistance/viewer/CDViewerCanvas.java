...
public class CDViewerCanvas extends Canvas {
    ...
    /* 現在の状態に属する環境の状態のリスト */
    private List<List<Integer>> currentStateList;
    /* ゴールの状態に属する環境の状態のリスト */
    private List<List<Integer>> goalStateList;
    /* 上位層からのサブゴールの状態に属する環境の状態のリスト */
    private List<List<Integer>> upperSubgoalList;
    /* 現在層でのサブゴールの状態に属する環境の状態のリスト */
    private List<List<Integer>> currentSubgoalList;
    /* オプション情報を設定するリスト */
    private List<List<Integer>> optionList;
     ...
     */
    public void setCurrentStateList(List<List<Integer>> currentStateList) {
     ...
     */
    public void setGoalStateList(List<List<Integer>> goalStateList) {
     ...
     * @param LinkedList goalStateList  環境の状態のリスト
     */
    public void setUpperSubgoalList(List<List<Integer>> upperSubgoalList) {
     ...
     * @param LinkedList goalStateList  環境の状態のリスト
     */
    public void setCurrentSubgoalList(List<List<Integer>> currentSubgoalList) {
     ...
     */
    public void setOptionList(List<List<Integer>> optionList) {
     ...
     */
    private void fillStateListPolygon(Graphics g, List<List<Integer>> stateList) {
        ...
        for (List<Integer> state: stateList) {
            fillStatePolygon(g, state.get(0), state.get(1), state.get(2));
        }
    }
