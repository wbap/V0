 ...
 * Citta
 */
public class DoorKeyDemo extends JFrame implements CittaRunner {
    ...
    private static final Logger logger = LoggerFactory.getLogger(DoorKeyDemo.class);
    ...
    public DoorKeyDemo(String propFileName) throws Exception {
        ...
        saveCount = props.getSaveStepNum();
        saveFileName = props.getSaveFileName();
        loadFileName = props.getLoadFileName();
    ...
    private void initGSA() throws IOException {
        ...
        final GSAFactory gsaFactory = new GSAFactory();
        gsaFactory.addGSAFactoryEventListener(new GSAFactoryEventListener() {
            @Override
            public void gsaCreated(GSAFactoryEvent evt) {
                final GSA gsa = evt.getGSA();
        ...
        gsaFactory.populateWithGSAProperty(gsaProps);
