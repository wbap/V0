 ...
 * <p>
 * A <tt>Module</tt> has zero or more <tt>inPorts</tt>, zero or more <tt>outPorts</tt>, and
...
//	process of this module (defined in the fire() method) from other modules.
	...
	/**
	 * Users may override <tt>fire()</tt> method to define a new sub-class of <tt>Module</tt>.  
	 * <tt>fire()</tt> method implements a function of the form<br>
	 * <tt>results, states <- fire(inPorts, states)</tt>,<br>
	 * which states that this method should be a mutator of these two member
	 * variables (<tt>results</tt> and <tt>states</tt>), and the result of the computation
	 * should solely depend on the values stores in (<tt>inPorts</tt>, <tt>states</tt>).<br>
	 * One important note here is that it shall mutate <tt>results</tt> member variable,
	 * and not <tt>outPorts</tt>.   Values stored in <tt>results</tt> will automatically
	 * be copied to <tt>outPorts</tt> by the scheduler which calls <tt>updateOutput()</tt>
	 * method of this <tt>Module</tt>, so these be visible and accessible from other Modules.
	 * This procedure is especially necessary in concurrent execution of multiple Modules
	 * to avoid contention.
	 */
	 ...
	 * @param length an initial length of the value vector.
	 */
	 ...
	 * @param id a string ID of the in port.
	 ...
	 * @param id a string ID of the out port.
	 * @return a value vector
	 */
	...
	/**
	 * Set a state of this Module.   If the state value of the specified ID
	 * does not exist, it creates one.
	 * 
	 * @param id a string ID.
	 * @param v a value vector.
	 */
	...
	/**
	 * Add a connection from port <tt>fromID</tt> of <tt>from</tt> Module
	 * to <tt>toID</tt> port of this <tt>Module</tt>. 
	 * 
	 * @param from
	 * @param fromId
	 * @param toId
	 * @throws Exception 
	 */
	public void connect(Module from, String fromID, String toID) throws Exception {
